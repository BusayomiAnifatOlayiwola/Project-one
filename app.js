...
//new - instance
// const dice1 = new Image(200,200)
// dice1.src = "./Dice-image.jpg"
// document.querySelector("main").append(dice1)

// start.addEventListener("click", e =>{
//     console.log("play")
//     //update div innertext to bonjour
// document.querySelector('.player1').innerText ="Player1"

// })

//play.classList.toggle('.player1')

//if click on (title) it will off(if click title)again it will off
